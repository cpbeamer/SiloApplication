...
extension UIView {
    ...
    func draw3DShadow(shadowColor: UIColor = UIColor.black, opacity: Float = 0.3, offset: CGSize, radius: CGFloat , shouldRasterize : Bool = false) {
        self.layer.shadowColor = shadowColor.cgColor
        self.layer.shadowOpacity = opacity
        self.layer.shadowOffset = offset
        self.layer.shadowRadius = radius
    ...
    func drawBookingShadow(shadowColor:UIColor = #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 0.798828125), shadowOpacity:Float = 0.14, shadowPath:UIBezierPath? = nil, shadowRadius:Float = 10, cornerRadius:Float = 6.0, offset: CGSize = CGSize(width: 0, height: 5)) {
